...
class HyperparametersRTE(Hyperparameters):
    def __init__(self):
        super().__init__()
        ## 1e-5, 2e-5, 3e-5
...
class ClassificationRTE(Task):
    def __init__(self, device,
               ...
               input_feat: list[str] = ['sentence1', 'sentence2'], output_feat: str = 'label',
               ipa: bool = False):
        if hyperparameters is None:
            hyperparameters = HyperparametersRTE()
        super().__init__(
            'rte',
