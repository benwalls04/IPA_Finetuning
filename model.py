...
class GPT(nn.Module):
    ...
    def forward(self, tokens):
        ...
        tok_emb = self.transformer.wte(tokens) # token embeddings of shape (b, l, n_embd)
    ...
    def from_pretrained(cls, model_type, override_args=None):
        ...
        print("forcing vocab_size=50257, block_size=128, bias=True")
        config_args['vocab_size'] = 50257 # always 50257 for GPT model checkpoints
        config_args['block_size'] = 128 # always 1024 for GPT model checkpoints
